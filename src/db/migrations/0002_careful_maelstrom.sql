...
-- Preserve legacy anonymous view counts while redacting raw IPs.
UPDATE "views" SET "viewer_ip_hash" = 'legacy:redacted' WHERE "user_id" IS NULL AND "viewer_ip_hash" IS NOT NULL;--> statement-breakpoint
